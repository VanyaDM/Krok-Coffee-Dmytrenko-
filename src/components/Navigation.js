...
function Navigation() {
    ...
    return (
       ...
       <Navbar bg="white" expand="lg"  className="main_nav mb-0 py-0" >
            <Container>
                <LinkContainer to="/">
                    <Navbar.Brand><img src="https://github.com/krokcoffee/krokcoffee.github.io/blob/main/img/Logo_76px.png?raw=true" className="logo" alt="/" /></Navbar.Brand>
                </LinkContainer>
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="ms-auto">
                        ...
                        {!user && (
                            ...
                            <LinkContainer to="/category/продукція">
                                <Nav.Link>ПРОДУКЦІЯ</Nav.Link>
                            </LinkContainer>
                        ...
                        {user && ( 
                            <> 
                                ...
                                <NavDropdown title={`${user.name} ${user.lastname}`} id="basic-nav-dropdown">
                                    ...
                                    <NavDropdown.Divider />
                                    <Button variant="danger shadow-none" style={{borderRadius: "10px"}} onClick={handleLogout} className="logout-btn">
                                        Вийти
                                    </Button>
                                </NavDropdown>
