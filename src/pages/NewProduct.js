            ...
            <Row>
                <Col md={6} className="new-product__form--container">
                    <Form style={{ width: "100%" }} onSubmit={handleSubmit}>
                        <h1 className="mt-4">Додайте новий товар</h1>
                        {isSuccess && <Alert variant="success">Новий товар успішно створено</Alert>}
                        ...
                        <Form.Group className="mb-3">
                            <Button className="btn_green shadow-none" type="button" onClick={showWidget}>
                                Додайте Зображення
                            </Button>
